...
const SliderSection = ({ image }) => {
  return (
    ...
    >
      ...
      >
        <div class="grid sm:grid-cols-2 place-items-center sm:my-12 sm:gap-20 gap-4">
          <div className="sm:p-10">
            <h3 class="sm:text-7xl text-3xl font-semibold mb-2 text-white">Información general y específica</h3>
          </div>
          ...
          <figure className="relative w-full p-10 sm:w-96 sm:p-0">
            ...
            <StaticImage src="../images/slider-1.png" />
          </figure>
        </div>
